...
<div class="d-flex flex-column flex-root">
    ...
    <div class="mb-0" id="home">
        <!--begin::Wrapper-->
        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg mb-10 mb-lg-20">
            <!--begin::Header-->
            ...
            {{-- <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                ...
                <div class="d-flex flex-column flex-lg-row mb-lg-10 min-w-lg-1000px py-10 py-lg-20">
                    <!-- First Column (Text) -->
                    <div class="d-flex mb-5 w-100 w-lg-75">
                        <h1 class="text-white lh-base fw-bolder fs-3x fs-lg-4x mb-15 slide-right-animation">
                            <span class="fs-4x">Hi! I am</span> 
                            <br /><span class="fs-5tx">Nathaniel</span>
                            <br /><span class="fs-5tx">Montano</span>
                            <div class="divider my-2"></div>
                            <span style="background: linear-gradient(to right, #874F41 0%, #FBE9D0 100%);
                                        -webkit-background-clip: text;
                                        -webkit-text-fill-color: transparent;">
                                <span id="kt_landing_hero_text" class="fs-3x">Full-stack Web Developer</span>
                            </span>
                        </h1>
                    </div>
                
                    <!-- Second Column (Image) -->
                    <div class="d-flex mb-5 w-100 w-lg-25">
                        <div class="symbol symbol-400px symbol-lg-460px symbol-fixed position-relative">
