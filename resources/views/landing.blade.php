...
@section('content')
    <div class="d-flex flex-column flex-root">
        ...
        <div class="mb-0" id="home">
            <!--begin::Wrapper-->
            <div
                class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg mb-10 mb-lg-20">
                <!--begin::Header-->
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center mb-lg-5 min-w-lg-1000px py-10 py-lg-20">
                        ...
                        <div class="d-flex w-100 w-lg-50 position-relative">
                            ...
                            <h1 class="text-white lh-base ms-lg-20 fw-bolder fs-3x fs-lg-4x slide-right-animation">
                                <span
                                    style="background: linear-gradient(to right, #874F41 0%, #FBE9D0 100%);
        ...
        <!--begin::How It Works Section-->
            ...
            <div class="container">
                ...
                <div class="row w-100 gy-10 mb-md-20 align-items-center">
                    <!--begin::Col-->
                    <div class="col-md-4 px-5" data-aos="fade-up">
                        <!--begin::Story-->
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <div class="symbol symbol-400px symbol-md-300px symbol-fixed position-relative">
                                <img id="dynamic-image" src="assets/media/images/me.png" alt="image" class="fade-in">
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--end::Story-->
                    ...
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-8 px-5" data-aos="fade-up">
                        <!--begin::Story-->
                        <div class="mb-10 mb-md-0">
                            <!--begin::Heading-->
                            <div class="d-flex flex-start mb-5">
                                <!--begin::Title-->
                                <div class="fs-2 fs-lg-1 fw-bold text-dark fst-italic custom-border">
                                    &ldquo;I’m a web developer — skilled not just in house chores, but in both frontend and backend development, with experience creating efficient and user-friendly web applications that make people’s lives easier and transform the way they do things online. <span class="text-muted">except the sketchy ones ;)</span>&rdquo;
                                </div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
        ...
        <div class="pb-15 pt-18 landing-dark-bg">
            ...
            <div class="container">
                ...
                <div class="text-center mt-15 mb-15" id="achievements" data-kt-scroll-offset="{default: 100, lg: 150}">
                    <!--begin::Title-->
                    <h3 class="fs-2hx text-white fw-bolder mb-5">Works</h3>
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="fs-5 text-gray-500 fw-bold">Personal Projects (some were for clients, others driven by boredom)
                    </div>
                    <!--end::Description-->
                </div>
                <!--end::Heading-->
                <!--begin::Statistics-->
                <div class="d-flex flex-center" data-aos="fade-up">>
                    <div class="tns tns-default">
                        ...
                        <div data-tns="true" 
                            ...
                            data-tns-rewind="true"
                            data-tns-autoplay-direction="forward"
                            data-tns-animate-in="tns-fadeIn"
                            data-tns-animate-out="tns-fadeOut">
                            <!--begin::Item-->
                            <div class="text-center">
                                <img src="assets/media/works/valorant.png" class="card-rounded shadow mw-100"
                                    alt="" />
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="text-center">
                                <img src="assets/media/works/valentine.png" class="card-rounded shadow mw-100"
                                    alt="" />
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="text-center">
                                <img src="assets/media/works/cybercrime.png" class="card-rounded shadow mw-100"
                                    alt="" />
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="text-center">
                                <img src="assets/media/works/ealaga.png" class="card-rounded shadow mw-100"
                                    alt="" />
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="text-center">
                                <img src="assets/media/works/cpdo.png" class="card-rounded shadow mw-100"
                                    alt="" />
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="text-center">
                                <img src="assets/media/works/hn.png" class="card-rounded shadow mw-100"
                                    alt="" />
                            </div>
                            <!--end::Item-->
                        </div>
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <div class="d-flex align-items-center order-2 order-md-1">
                            ...
                            <a href="../../demo1/dist/landing.html">
                                <img alt="Logo" src="assets/media/svg/second-logo.svg" class="h-15px h-md-20px" />
                            </a>
                            <!--end::Logo image-->
                            <!--begin::Logo image-->
